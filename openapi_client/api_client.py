...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.handle_add_channel  # this is an instance of the class Endpoint
        api_instance.handle_add_channel()  # this invokes api_instance.handle_add_channel.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.handle_add_channel.callable or self.callable in this class
