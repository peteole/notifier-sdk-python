...
from notifier/clients/go import rest
from notifier/clients/go.configuration import Configuration
from notifier/clients/go.exceptions import ApiTypeError, ApiValueError, ApiException
from notifier/clients/go.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CrateApi()
        api_instance.handle_add_email_channel  # this is an instance of the class Endpoint
        api_instance.handle_add_email_channel()  # this invokes api_instance.handle_add_email_channel.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.handle_add_email_channel.callable or self.callable in this class
